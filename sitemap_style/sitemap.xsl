  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/sitemap_style/jquery.min.js"/>
        <script type="text/javascript" src="/sitemap_style/jquery.tablesorter.min.js"/>
        <script type="text/javascript" src="/sitemap_style/parser-date-iso8601.min.js"/>
        <script type="text/javascript" src="/sitemap_style/simple_sitemap.xsl.js"/>
        <link href="/sitemap_style/simple_sitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
      <body>
        <h1>Sitemap file</h1>
